...
/**
 * check_elf - it Checks if a file is an EL.
...
/**
 * print_magic - it Prints magic numbers of ELF header.
...
/**
 * print_class - it Prints class of ELF header.
...
/**
 * print_data - it Prints data of ELF header.
 * @e_ident: array containing ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_osabi - it Prints OS/ABI of ELF header.
...
/**
 * print_abi - it Prints ABI version of ELF header.
